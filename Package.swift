...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.4.0-beta.11.xcframework.zip",
			checksum: "b072a9fa39fe601fe48045af68101160e3fb7c7f9bdefae84cb63a55fc26d1ee"
		)
	]
)