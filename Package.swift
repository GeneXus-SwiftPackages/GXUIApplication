...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.17.xcframework.zip",
			checksum: "6f05f2ee376671892d8ea6ac99c9105e7a7ead49f1dacfb58a214d3a00d39cea"
		)
	]
)