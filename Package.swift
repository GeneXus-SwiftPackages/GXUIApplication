...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-4.2.0-rc.3.xcframework.zip",
			checksum: "31c2269bb0d9b0e0b9e2e12351af7b789b6a458185d4e9b8385870ea015831b3"
		)
	]
)