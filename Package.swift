...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.9.xcframework.zip",
			checksum: "abfad45fa2449adc182a570c6c399a38827f94e09b0f944caa48120a60adb8ce"
		)
	]
)