...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.3.0-rc.13.xcframework.zip",
			checksum: "2fedafd213bef34929de70d9aef75ecd97749279f4d4b15aeb860406eb13845a"
		)
	]
)