...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-3.0.3.xcframework.zip",
			checksum: "ec3c5d6474fe76a4d90109d641f7c08f0dfd053cc525f95012a4e8103d47adf2"
		)
	]
)