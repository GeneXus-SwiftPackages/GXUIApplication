...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.26.xcframework.zip",
			checksum: "2e9b5e7563fae2dd319b47d681120961783c0b71b815d77e284c5ceddedd5b06"
		)
	]
)