...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.2.xcframework.zip",
			checksum: "951302dc5ab85f43afa778f1cb35b79a1e6f4942fdeaba007656f14b1eaf4c0f"
		)
	]
)