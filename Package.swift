...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.1.0-beta.12.xcframework.zip",
			checksum: "4f1776fb983196e8665c888201fdc48431979468e27d13c25257d60e489affe1"
		)
	]
)