...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.25.xcframework.zip",
			checksum: "37005f4b7aa44277069f52abe90ada6f8bf062cefc746ec8b89729c67d7a631c"
		)
	]
)