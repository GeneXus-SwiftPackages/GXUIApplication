...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.17.xcframework.zip",
			checksum: "8cf7361d1d2c7872451aabb7a8eee44f1770a5980c99bf145906d9c39be03cb6"
		)
	]
)