...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.0.xcframework.zip",
			checksum: "94253441cd7675a0ee225e99342ecc6b19ee301fd55f4632b2022e44dc62985b"
		)
	]
)