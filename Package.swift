...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.18.xcframework.zip",
			checksum: "4f4354380b8699dd361c6533feebec24bad2b3f8d190e60616499f6fc4514067"
		)
	]
)