...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.24.xcframework.zip",
			checksum: "1b910f128df310e355780e3145077edd3978114daf6067f351fa1614b0873f62"
		)
	]
)