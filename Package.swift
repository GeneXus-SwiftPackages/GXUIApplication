...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.1.0-beta.6.xcframework.zip",
			checksum: "e97595d24e5989f2fc5116587e28694062efd65ffd0c970bc722259ce12c99ad"
		)
	]
)