...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.0.0-beta.14.xcframework.zip",
			checksum: "8b53f241579e8a1b14f7ae9fd69d81e2ccfe88daab7e4065c8f3a7e188b6bef9"
		)
	]
)