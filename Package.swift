...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.29.xcframework.zip",
			checksum: "bf7cd8f46eed6ec0e1241c29364a4ad0b3e83c8666448aa611083f01a562141d"
		)
	]
)