...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.40.xcframework.zip",
			checksum: "fb92389fa86f1db7c5d6d17940a668a00c97f9a7ac936068c4ccdc9710a30eec"
		)
	]
)