...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.2.0-beta.19.xcframework.zip",
			checksum: "459b60b7f5bfdaab341c36122f99eb675aefd086b9522c1bcc27241ddc10ed2f"
		)
	]
)