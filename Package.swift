...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.6.0-rc.0.xcframework.zip",
			checksum: "ce69caccea5e2a2271669ef10c9c378f5234940c6921cf9a6d6e6f0389be11a2"
		)
	]
)