...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-3.2.0.xcframework.zip",
			checksum: "9fa0de9e544aa4c8c218a179913f97842ea4afb37e6645cf0ac0f6d3f2fd6127"
		)
	]
)