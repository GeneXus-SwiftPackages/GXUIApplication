...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.11.xcframework.zip",
			checksum: "4f4505e4ad11b011282e3f8bcb5b4662015731c176d1b5d1978bfc4ee78219cc"
		)
	]
)