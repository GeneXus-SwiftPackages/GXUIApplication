...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.3.xcframework.zip",
			checksum: "c3a145934f6245aba5d0c02f9b650f5084a302cace81f853ba841d2a6656b043"
		)
	]
)