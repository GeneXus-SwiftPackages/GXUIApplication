...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.2.0-rc.36.xcframework.zip",
			checksum: "877885b5e5430104372375b01c862143d27bdbce713c93caae9a2e150e511b2a"
		)
	]
)