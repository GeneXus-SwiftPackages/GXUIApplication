...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.2.0.xcframework.zip",
			checksum: "1c86a5a8c00fd6c4b305dd5f97875553d542d25d6829908ea468c7cba9c923d6"
		)
	]
)