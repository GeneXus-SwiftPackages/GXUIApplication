...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.23.xcframework.zip",
			checksum: "0650c36b1df9792756ef7e13f18055f6e7391b61b3dbe85e7207c23212d0c092"
		)
	]
)