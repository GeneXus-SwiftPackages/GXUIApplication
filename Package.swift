...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.21.xcframework.zip",
			checksum: "cd313e01522349d885bc876bcbc153f048684f72047282678c8ce5e784b0f9cd"
		)
	]
)