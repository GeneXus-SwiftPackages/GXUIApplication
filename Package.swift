...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.5.0-rc.28.xcframework.zip",
			checksum: "3ea6875f3a5ffacf0a84aad3d4fe113925919ad37f217cc0aa61af07cdd65a58"
		)
	]
)