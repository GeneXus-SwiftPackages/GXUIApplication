...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.17.xcframework.zip",
			checksum: "3efe1eab148a45b9b078ab7b1a5de41d04cca0d147288a028150341c4bbc9d23"
		)
	]
)