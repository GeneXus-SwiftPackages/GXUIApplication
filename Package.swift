...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.12.xcframework.zip",
			checksum: "780a01af9f0d8b364627e5754ac3e9dd330b96fc56620c9bdb1041a1c41ae802"
		)
	]
)