...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.8.xcframework.zip",
			checksum: "8a376d2e471b16176f9328d7ba47a1e123e889179a209afe945931d0a2314265"
		)
	]
)