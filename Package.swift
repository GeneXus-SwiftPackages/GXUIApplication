...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-2.1.0-rc.25.xcframework.zip",
			checksum: "74e2b30dc311b731357aa40d3a81b50588475c4673dc9320a5dea3b7e6e5f957"
		)
	]
)