...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.39.xcframework.zip",
			checksum: "d93a88a5f961635c665fd125c5f87c26db95b0160df6871b1eee2ae39fc4bb4f"
		)
	]
)