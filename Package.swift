...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-3.0.1.xcframework.zip",
			checksum: "ca6dd8b65d6127b7195d65711135f2f7a3d861ac7197bc2770dae723b3f2ec84"
		)
	]
)