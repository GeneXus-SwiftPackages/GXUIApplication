...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.12.xcframework.zip",
			checksum: "4f487b6864b957899ca67831f57e699e998814d965101f1739132b2c08f1a55c"
		)
	]
)