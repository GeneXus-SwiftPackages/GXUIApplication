...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.23.xcframework.zip",
			checksum: "8bbbb0eec9045d5dc09a6a3925bad1b703e107a2d2f1b074d9b90df8cbdbabc3"
		)
	]
)