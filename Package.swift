...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.6.xcframework.zip",
			checksum: "a73d0c960a1d414d175d4f6cc0585f48bf9dfbca6358ce974357ea465cd29f69"
		)
	]
)