...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.37.xcframework.zip",
			checksum: "42816ce08b6f04c4d44f6f5fb7f35d792868a33a1f7f4d7fe2f300c1cf70fc0b"
		)
	]
)