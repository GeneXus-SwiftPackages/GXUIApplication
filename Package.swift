...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.18.xcframework.zip",
			checksum: "5e87b23c407e7e913c7d012f40379f864d20087d6d8ec4c59b8edfe36a1d923d"
		)
	]
)