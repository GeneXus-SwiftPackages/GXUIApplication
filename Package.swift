...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.10.xcframework.zip",
			checksum: "4f3c0dddf3704f953e448e101bc17ea6345d188ec96b36dbbd37ab6ba7a29197"
		)
	]
)