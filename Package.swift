...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.32.xcframework.zip",
			checksum: "b9606fbaba05ee419fd97555a4f2818f788f8317ae034d9e2e7b58706966e7d9"
		)
	]
)