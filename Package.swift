...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.1.0-rc.4.xcframework.zip",
			checksum: "a7c1eddb0c3aad5a39007e424e2a7ff9892a9b1f956b30ddfc5109181daff515"
		)
	]
)