...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-2.0.18.xcframework.zip",
			checksum: "9632919fedd953a695fad5908284dc784c6075ceba94baeecc5d6a15eec1e99e"
		)
	]
)