...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.23.xcframework.zip",
			checksum: "cb17cbba4ddd101497825e1e91b669dc3ccb275c8aa0ab5f1f30da8037f4ab3f"
		)
	]
)