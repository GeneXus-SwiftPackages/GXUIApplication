...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-3.0.0-rc.15.xcframework.zip",
			checksum: "ca588e3f9eedd21ce5485f3b00e71e184e951bbd8f4aad7513329ce253eea2c4"
		)
	]
)