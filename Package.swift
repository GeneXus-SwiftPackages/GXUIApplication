...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.16.xcframework.zip",
			checksum: "67e1c6afee3b23036c2ec9c9ca6ad9e677a89fae4070043e31b829aaf96824ea"
		)
	]
)