...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.15.xcframework.zip",
			checksum: "24f6af51849dbc35e964fae2ed2bd87018a83d07b17392be5f9dcb91d7b7536a"
		)
	]
)