...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.9.xcframework.zip",
			checksum: "2e34f82408da5c04e6fba9c7fa7ba1197e310c9e7fdb01d3c41523487a19988b"
		)
	]
)