...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.1.1.xcframework.zip",
			checksum: "b2fbdeba6be6a9436fcf044e9842c4fe9da87f159a6037664558230c2e90b0af"
		)
	]
)