...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.33.xcframework.zip",
			checksum: "9f2a1ac272be5298b9a26650644aac8d1111c1272d85ec01ede22360e0eaa69c"
		)
	]
)