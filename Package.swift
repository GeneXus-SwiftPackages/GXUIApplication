...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.6.xcframework.zip",
			checksum: "649373e54129e21ebf318a18b02aea394a895d4f2e27bf9df2efaf613601064b"
		)
	]
)