...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.19.xcframework.zip",
			checksum: "714a04735d9f6a9508de5762195aa08c74e32729d84d841f9e9d145e050e6fde"
		)
	]
)