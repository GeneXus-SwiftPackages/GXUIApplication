...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.11.xcframework.zip",
			checksum: "bdba2a2cf7ec5bacda9edeabf30f5003c98d228bb8346920171f3f08eac73fec"
		)
	]
)