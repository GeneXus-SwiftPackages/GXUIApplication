...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.3.0.xcframework.zip",
			checksum: "249b3b9c8073eeedcd1d622b6fb9f210eda71ebc1b9e45ecbaa337fbf0fb8fd7"
		)
	]
)