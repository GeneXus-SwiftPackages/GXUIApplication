...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.0.2.xcframework.zip",
			checksum: "996c3671f7c79722b58374f8a55c5fe96e62dc5a05415e09ac65fd7a9b819e93"
		)
	]
)