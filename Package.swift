...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.27.xcframework.zip",
			checksum: "0b609b806ae431001e1fc2f6a885dfecadc966ddfffdb370bf262e36d93d0642"
		)
	]
)