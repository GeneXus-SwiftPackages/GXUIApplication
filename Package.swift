...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.0.0-beta.49.xcframework.zip",
			checksum: "e780faf8f7c8533ae8eb100b8d20c4256941638a6cf91d3b650930d9d3df482e"
		)
	]
)