...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-5.0.0-rc.1.xcframework.zip",
			checksum: "dff636c711e64847877fc67fde4dedfbbe120e5bd6233c279dce45d6479bf08a"
		)
	]
)