...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.29.xcframework.zip",
			checksum: "2dbb10209da53912e65fa730991ef444c7ff4bb7e43b15cd00e00b4e1262a9c3"
		)
	]
)