...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.6.0-beta.4.xcframework.zip",
			checksum: "b6be7c4b1e2084407913ff0f86c0d732126651e1a4e8f1f92e77a19e6f6fcf8e"
		)
	]
)