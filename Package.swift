...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.22.xcframework.zip",
			checksum: "fba3f95cd78105fe974cf52eb9e41cf704c9b4ed667d83ffb6568a1a32ef1faf"
		)
	]
)