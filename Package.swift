...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.1.xcframework.zip",
			checksum: "ab0e97cf37f8d5795584f7ed8364a73ee51f7ff7036c77a134f997b0ba3741e6"
		)
	]
)