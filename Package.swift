...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.28.xcframework.zip",
			checksum: "e11b20f21f3ce1ad08230f50d265da1f9ec782aa53b92699072d29a8c9d47933"
		)
	]
)