...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.27.xcframework.zip",
			checksum: "da3c30167d509d7c228ae3ea2b124cc217dc20498d20260b0d77ccdaa01e6189"
		)
	]
)