...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.10.xcframework.zip",
			checksum: "0885b85efbb8e5e34f383f7cd906a279918e2973f5780d142573c05d905385fc"
		)
	]
)