...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.6.xcframework.zip",
			checksum: "7f9a811311524a0310f3d9536d71ec729dd7fec20fa2ae3c8e720e41fa0b129a"
		)
	]
)