...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.6.0-beta.2.xcframework.zip",
			checksum: "de651b8bd182526a0d18a0fbf5014988e12c66621e716924f8d206bdca604cff"
		)
	]
)