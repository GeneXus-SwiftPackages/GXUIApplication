...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.33.xcframework.zip",
			checksum: "bed46cbb165241022a85183e64dfed47ff98b0d177a08fcdaadd135675881c3f"
		)
	]
)