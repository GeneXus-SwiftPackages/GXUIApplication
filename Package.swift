...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.1.0-beta.26.xcframework.zip",
			checksum: "07b637854df93767a480b874dede3aa2eeb0a0e41c1dc6fd39141e75bc8d1fc0"
		)
	]
)