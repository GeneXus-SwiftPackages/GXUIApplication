...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.1.2.xcframework.zip",
			checksum: "90fa4e7b89b2f8eb0199df6baffa0825eb40e1a9ba376f313b4239993ab770a8"
		)
	]
)