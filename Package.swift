...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-3.0.2.xcframework.zip",
			checksum: "cd6537104fe5cc81f91f73ef8dcad506562908c818408055d34160799cb911b1"
		)
	]
)