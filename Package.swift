...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.4.0-rc.1.xcframework.zip",
			checksum: "2a1c3779b1db603b9009b898b2161cdacf2255d23c4eaf8c197becdbee01eece"
		)
	]
)