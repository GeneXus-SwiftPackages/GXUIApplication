...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.2.0-beta.20.xcframework.zip",
			checksum: "af2b73b431ca6037526f07d69319a452c800b4de8e3e9c874d3693d22e03c324"
		)
	]
)