...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.3.0-rc.7.xcframework.zip",
			checksum: "e278d418f8ad1327960c34b5a039b88d78b86b39592ea29d893df7cdb197cdb8"
		)
	]
)