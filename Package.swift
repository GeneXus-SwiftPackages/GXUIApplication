...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.19.xcframework.zip",
			checksum: "72eed2baaa4426f70c524f74aa0de923b89b0f1a7def89c17fc7195e894d476b"
		)
	]
)