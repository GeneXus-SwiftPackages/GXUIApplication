...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.4.0-beta.19.xcframework.zip",
			checksum: "0a551c1d241a9641c3bb69e19a56bd404b792ec2cfe7420302bf86944156af1b"
		)
	]
)