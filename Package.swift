...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.2.0-beta.14.xcframework.zip",
			checksum: "d75fd9047034b1eee829b9fcfb397cb9e3cdf195f80724901b94a1670b45f417"
		)
	]
)