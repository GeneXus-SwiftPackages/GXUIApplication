...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.29.xcframework.zip",
			checksum: "fb74db852c30a56000a9740a1b46f82d2299c32c2c83e1e1e50c9ec84f9ee774"
		)
	]
)