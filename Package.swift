...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.31.xcframework.zip",
			checksum: "3ff60b28b5b976c86dc1d5e7f21fbd1b6a05997710de199ed5283909f53809ec"
		)
	]
)