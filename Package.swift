...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.16.xcframework.zip",
			checksum: "94c5dd9e444afd2a5d4b131d8f8b3687130fb3f31d33979cfffe98dbb4aa59b0"
		)
	]
)