...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.30.xcframework.zip",
			checksum: "3e4db15b98b89bca7a538637271aaab24287aca004e08a9376b8deeeda647f0c"
		)
	]
)