...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.32.xcframework.zip",
			checksum: "3d50b4108e3a91c1d5d2a44fe008733b9ddf43959017e2d71ae5b5526efc865d"
		)
	]
)