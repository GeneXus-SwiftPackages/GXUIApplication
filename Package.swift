...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.0.0-beta.20230615110131.xcframework.zip",
			checksum: "e3051cb55346f12b993c039dd0b691c085b10adda2b3a7a144b23684de14f262"
		)
	]
)