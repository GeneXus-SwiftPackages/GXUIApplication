...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.40.xcframework.zip",
			checksum: "3749191a85e5decac831cc952a5466381c741ca9a6c30ccb1ad334f2d679d782"
		)
	]
)