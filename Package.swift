...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-2.0.0-rc.36.xcframework.zip",
			checksum: "5b6218c73fdaa4eaf000ea10abda8b52f5ee1bf0c696183b5d8cae7532927cd3"
		)
	]
)