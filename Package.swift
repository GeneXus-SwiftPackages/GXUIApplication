...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.24.xcframework.zip",
			checksum: "79fc2024d6a6b65055749953adab8099e356246ec382f110d6e19341fa002073"
		)
	]
)