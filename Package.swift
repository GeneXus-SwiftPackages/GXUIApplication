...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.9.xcframework.zip",
			checksum: "2c1f60167e4c26ad9e62e64f71c971bf29ac59c3f0731d4a3ad0cca6565f6b54"
		)
	]
)