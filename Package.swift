...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-4.1.0-rc.25.xcframework.zip",
			checksum: "a45cac07c481af3245d99e421ef1ab8e5f5da23ac3e2e778c346bd820a2e177f"
		)
	]
)