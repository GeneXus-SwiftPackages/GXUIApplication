...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.4.0-beta.2.xcframework.zip",
			checksum: "290a950bde0be482d51f604aeb39f47b9cce47733592616f9733ac7134abff59"
		)
	]
)