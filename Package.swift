...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.4.0-beta.5.xcframework.zip",
			checksum: "9d058fb60621ed7cf989abb58f108c2c60319ead7a69871f80b5cabb7400e58f"
		)
	]
)