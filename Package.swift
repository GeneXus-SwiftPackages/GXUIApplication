...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.0.8.xcframework.zip",
			checksum: "506f516f4faa59f801b89a4679da462f9b994342fab5f7d3227d7d8aa907e2f6"
		)
	]
)