...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.3.6.xcframework.zip",
			checksum: "b5e8c556dab19a2013168ee41b15458398e9a1178daef4fdfecd900c5dff95d3"
		)
	]
)