...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.1.xcframework.zip",
			checksum: "3d26d5c7bd81de4be21dfd8920bc20cc5a15056af85874c94736d3f38387b7aa"
		)
	]
)