...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.15.xcframework.zip",
			checksum: "8536475bb54ba36d20483e9f8bf0f0cc2ad76d64f17e291524a26092dd4340b9"
		)
	]
)