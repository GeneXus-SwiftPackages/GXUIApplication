...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.18.xcframework.zip",
			checksum: "19cc7a82d65f9a548cd013a3f9c6daf9a7e9df42112f1af12315c02a48994a46"
		)
	]
)