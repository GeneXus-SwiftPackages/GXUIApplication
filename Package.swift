...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.0.17.xcframework.zip",
			checksum: "1c6079d7dd69d2513cdfd0912e778e0bf31269890294184450274b86b399daaf"
		)
	]
)