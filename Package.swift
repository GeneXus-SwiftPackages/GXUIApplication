...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.2.0.xcframework.zip",
			checksum: "c7decd87c57dd4c8ab96943c73f1b84fa08a5bc29ea3434f6e4d35c2ed9d1dfd"
		)
	]
)