...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.27.xcframework.zip",
			checksum: "376a92f6425133e0efbdfb6472f5f5d49561713afbdcb090828a4bd6498ec315"
		)
	]
)