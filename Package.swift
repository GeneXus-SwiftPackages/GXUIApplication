...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.23.xcframework.zip",
			checksum: "087a47b0c3b0907b14b82ae7ed716b74ca5a07ba4498c7537127a79b5d5a0bdd"
		)
	]
)