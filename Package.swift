...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.1.xcframework.zip",
			checksum: "29260216460ce48e6d98c4290209f77edfd9542ed5b590b3ce5509b332811729"
		)
	]
)