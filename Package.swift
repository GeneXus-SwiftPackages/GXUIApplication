...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.37.xcframework.zip",
			checksum: "8ab930974d98f8ab7476831a985209a6e51b26e17766f152dc3ea1749b702087"
		)
	]
)