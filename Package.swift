...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.38.xcframework.zip",
			checksum: "1885d38ea979b55e1531818730064835bfc57e4c3bf1e8678519d1055dcfaf28"
		)
	]
)