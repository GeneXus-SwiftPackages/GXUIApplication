...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.1.0-rc.1.xcframework.zip",
			checksum: "a756c048178783b819a047a12c7757b5a2fa5bfcbfdf299f696df9a96e84d101"
		)
	]
)