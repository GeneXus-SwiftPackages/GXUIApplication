...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.0.4.xcframework.zip",
			checksum: "b5d56df3b09b658911d4527b74764ce0590df3228a6313c61fa78b57b14529f9"
		)
	]
)