...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.2.0-beta.15.xcframework.zip",
			checksum: "d6b2b991912ce842bfbe345369d5f671b975c09ffdd92a00c144c76a8ee9aea2"
		)
	]
)