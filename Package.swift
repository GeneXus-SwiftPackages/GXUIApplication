...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.5.0-rc.26.xcframework.zip",
			checksum: "5bcdda4e135ec152a6b28d1d2fee11aa8178279e3d5abb2dee71660b99aaad50"
		)
	]
)