...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.18.xcframework.zip",
			checksum: "f9e65664fccbbbcc89cc10c7064bb536e6bffab5368eebe3060e163541eef21f"
		)
	]
)