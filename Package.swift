...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.4.0-rc.10.xcframework.zip",
			checksum: "2ba93b4c60d179bf20b9e3816aaf540dcc37f441badfc278338abbe79ab0360f"
		)
	]
)