...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-4.2.0-rc.37.xcframework.zip",
			checksum: "ab9f48d5cd3815c311ef436649f2dc25239a0bafae77303eae0fcb452b29bb90"
		)
	]
)