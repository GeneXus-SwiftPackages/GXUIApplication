...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.8.xcframework.zip",
			checksum: "1199d58826e76406050426c0b40e3c548669e251e453886971213d7d8fe63745"
		)
	]
)