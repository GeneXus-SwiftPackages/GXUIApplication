...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-2.0.12.xcframework.zip",
			checksum: "357e037c5397bc6ead625abed42d82e667f3a505c99aa3d6acd8f49d16b4ade8"
		)
	]
)