...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.7.xcframework.zip",
			checksum: "4e69f07a118492e1e5d4ee3b8cf17c1dcfc6ac5934bf39c346c4f29305e2230a"
		)
	]
)