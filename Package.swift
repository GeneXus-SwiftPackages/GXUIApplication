...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.0.0-beta.48.xcframework.zip",
			checksum: "16784c58d2af241e2665b12e1e038fa3b73783db86d394e2e3e3a8accf2d2352"
		)
	]
)