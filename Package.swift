...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-3.1.0-rc.8.xcframework.zip",
			checksum: "ebe2bc8b2ff3150441236ed34648b1929d1b985ef2885bedc7d700dd68b5d709"
		)
	]
)