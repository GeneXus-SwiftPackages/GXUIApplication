...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.0.0.xcframework.zip",
			checksum: "adb33244e2fe51fc30b272f0750e2f2177c100ce115d72aef9a713aa1e67e73f"
		)
	]
)