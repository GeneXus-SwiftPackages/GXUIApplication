...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.21.xcframework.zip",
			checksum: "463b162f2153f387216cbd16f9a798daaf9a6ee5fdfa27812af5f1895fad9cbd"
		)
	]
)