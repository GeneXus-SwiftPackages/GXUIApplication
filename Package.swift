...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.18.xcframework.zip",
			checksum: "469b1a2cd412eaeb8a6ffc48194a35861674875b180f78ed1a23d8e9bc3e1bfb"
		)
	]
)