...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.0.0-beta.0.xcframework.zip",
			checksum: "c8c40de912e6fec8db3e15938e32688cc420bca2bc0313097e9ba05c0ae73596"
		)
	]
)