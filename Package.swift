...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.15.xcframework.zip",
			checksum: "f9843d3fd405a9efeea2110ad49eb13752fb4a470edaab1bd5102a0d0f760f80"
		)
	]
)