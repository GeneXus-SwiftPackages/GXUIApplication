...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.19.xcframework.zip",
			checksum: "1376964da4b1f8db23f90dfcf8572cf9e01e737f47a5315487c3cea46301ded2"
		)
	]
)