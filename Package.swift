...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.16.xcframework.zip",
			checksum: "10c1c095aa57815165736d3404b86b49b259dd702e8fbf223397a48a0f7256ff"
		)
	]
)