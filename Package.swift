...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.3.xcframework.zip",
			checksum: "2fc26c20c21db28355782275ddfcf39487bbb5143192a9fc2cbb8474c58a2e3c"
		)
	]
)