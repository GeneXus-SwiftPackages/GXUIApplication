...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.0.0-beta.45.xcframework.zip",
			checksum: "221cd04ab3e06c6024acaa388865d5d228fff2c918d5754edae05c902c78f23b"
		)
	]
)