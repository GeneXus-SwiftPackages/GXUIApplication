...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.24.xcframework.zip",
			checksum: "eb19b16811d57ff124ae20ec1c6d890ac2385f7f7ef8c9944b1d4b9ed7056333"
		)
	]
)