...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-2.2.0-rc.3.xcframework.zip",
			checksum: "8e294c574c285287a05917ed7b14a35cbb91113efdffeef097b66531b648093a"
		)
	]
)