...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.29.xcframework.zip",
			checksum: "ce0a88bc0fb1a80382438042f59b76dd85c4cd33fe0cf035d828e5283158573d"
		)
	]
)