...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.25.xcframework.zip",
			checksum: "9ba4336c7be6b0b3ef6891c973eaaf0ec0597a5bf4ab13aa8ce4cf0074b9a595"
		)
	]
)