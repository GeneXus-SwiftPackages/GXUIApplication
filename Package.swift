...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.28.xcframework.zip",
			checksum: "d5788d2b51a028cfb82c7e9e27dc4a384b110be02c8a1647d194a65d184bbfcd"
		)
	]
)