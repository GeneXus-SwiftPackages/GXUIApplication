...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.0.5.xcframework.zip",
			checksum: "9866cb78c192c01129a20177c47f68614801126eaba54631a7fd490f4e62512d"
		)
	]
)