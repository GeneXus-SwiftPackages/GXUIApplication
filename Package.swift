...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.7.xcframework.zip",
			checksum: "9fa3f33c0b022210d8746676acbd9bf1ab41e080ffd4a6d51151b56290f0dfce"
		)
	]
)