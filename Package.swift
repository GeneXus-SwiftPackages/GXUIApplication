...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.25.xcframework.zip",
			checksum: "be830f1c4d258f6dee0baa734960b92be64cbb536638ecfb79a2b0e58d9f306b"
		)
	]
)