...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.0.0-beta.20230707153504.xcframework.zip",
			checksum: "100f859cf813bfeabdcf487567335879bb223c22a0083a5bffe90564fad1621d"
		)
	]
)