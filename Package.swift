...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.1.0-beta.25.xcframework.zip",
			checksum: "4a9a30858798ae6d74cd8d59f77a50ac1cf7c3b763e209388e6c821ad421a6c1"
		)
	]
)