...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-2.0.0-rc.32.xcframework.zip",
			checksum: "c5926f38e30be8470d341ab3e7353b8d687165153ec0cbcb3a665ba11ff93c76"
		)
	]
)