...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.0.0-beta.11.xcframework.zip",
			checksum: "e3dae69d8ffd8f2484903d037f3d9ca4a03f698ed11632d000e301d67d13de95"
		)
	]
)