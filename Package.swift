...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.7.xcframework.zip",
			checksum: "def75aca03a0814915df4ed3afc944b8d15773ce5179a1c80f031b527cccfddd"
		)
	]
)