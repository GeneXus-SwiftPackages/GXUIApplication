...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.1.5.xcframework.zip",
			checksum: "eae1bf277f0fbf7fe1d8e94dde41d18c582df320076cfb37200c0009bfefd706"
		)
	]
)