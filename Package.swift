...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.8.xcframework.zip",
			checksum: "91455cdaf8a91e395bca75693b20424fe523de95b20e62a2bc05845bc930ce57"
		)
	]
)