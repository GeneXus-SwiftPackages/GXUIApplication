...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.13.xcframework.zip",
			checksum: "4972c4255aa719927f5ca157c5b51310e1e973c15065de81bcec1a786fc88aac"
		)
	]
)