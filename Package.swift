...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.21.xcframework.zip",
			checksum: "dd8a824c20a5fbc4b9186a05a2e3afedbfe93f7a8b53187d41c81a06e1212556"
		)
	]
)