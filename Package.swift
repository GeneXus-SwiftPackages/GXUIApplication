...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.1.0-beta.8.xcframework.zip",
			checksum: "9cf9728180aed0ea396c89529ea15c424636a3203e48b0e279a2948b349070b8"
		)
	]
)