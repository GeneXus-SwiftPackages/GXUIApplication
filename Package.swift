...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.32.xcframework.zip",
			checksum: "7593dbaea88d1cc44904a154fe7058832327b8e77497a7fa6363728c98c0dcec"
		)
	]
)