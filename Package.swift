...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-3.0.4.xcframework.zip",
			checksum: "215a9ac8d751bf53196dd8b896c9e6de178d84994d96cb4b75d6e613de8674a2"
		)
	]
)