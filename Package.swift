...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-2.0.0-rc.22.xcframework.zip",
			checksum: "16792a938d54b3ca0efe32c194d7f566d59c85625b5fdb2e19669bc35d1f0bcc"
		)
	]
)