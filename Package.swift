...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-3.0.7.xcframework.zip",
			checksum: "c2c2b125f283a9348f4139e367a47cd1826a4ddb49651028e6266570f4fee8ff"
		)
	]
)