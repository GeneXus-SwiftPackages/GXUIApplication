...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.2.xcframework.zip",
			checksum: "80d4fa1e5bff64374f82dfc5d577c9dbeb5fc0e7e908b34645b3ee39277696f0"
		)
	]
)