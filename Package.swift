...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-3.0.0.xcframework.zip",
			checksum: "4cc48dbfe53562acb32e9ffdb38f29f1f434b80d1a5ed1d3425b389fd2346dea"
		)
	]
)