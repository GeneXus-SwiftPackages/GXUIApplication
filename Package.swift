...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.38.xcframework.zip",
			checksum: "2ddd6f67e7c543df508fece4bd2529a43093b454500b7709f45e9865c28acd50"
		)
	]
)