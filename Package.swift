...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.1.0-beta.794.xcframework.zip",
			checksum: "3c65c8e00592ed4595d53321b931cbbab209adcf46dacffb5e290da24fa3b5aa"
		)
	]
)