...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.0.0-beta.47.xcframework.zip",
			checksum: "17b081bb0dfd552b10fb9cdee4420420c2c05378447008e832e3c66a8c8b32bc"
		)
	]
)