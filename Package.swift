...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.1.0.xcframework.zip",
			checksum: "1ae93d2198dfe1d27200cae40bd96db201a929d48bf76b6872fc34d667e073cd"
		)
	]
)