...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.19.xcframework.zip",
			checksum: "e4a59959e34d0f3215f2f2fc1daa79d5478a3a1f29621ee6ac9422638e6d0d70"
		)
	]
)