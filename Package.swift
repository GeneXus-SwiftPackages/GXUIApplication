...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.20.xcframework.zip",
			checksum: "eecdc6006631c64404a513bba02a0d637b0df63b62112992cf27bc85ed3cc703"
		)
	]
)