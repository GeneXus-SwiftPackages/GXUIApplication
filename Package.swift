...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.31.xcframework.zip",
			checksum: "ec5989a962537b0d23d7b3ce81a93b144b449df6dcbe5af1333cfc67a06dd868"
		)
	]
)