...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.11.xcframework.zip",
			checksum: "acf505c49e14580d7d57737b72a14a1c1cf963dbb4a33f95a9db27c26b100e5e"
		)
	]
)