...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.14.xcframework.zip",
			checksum: "101663bee8e0700eee550b777e2074752861911cf96e5a500fac8fd73fa2e360"
		)
	]
)