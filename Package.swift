...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-4.2.0-rc.20.xcframework.zip",
			checksum: "79e3ee34a993ba104b1985cf9642620b7d682af5f8ecde0fcbd271a5f112c34a"
		)
	]
)