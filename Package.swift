...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.5.16.xcframework.zip",
			checksum: "5c7f35fa72cf37d15f50973c7e6f604a02e1dd2bae492b022493c9e398a5a0a9"
		)
	]
)