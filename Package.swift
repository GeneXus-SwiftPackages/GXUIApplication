...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.2.0-rc.15.xcframework.zip",
			checksum: "45be5d9b3173a99bea1f918fdd0971f53e30df91dd739bd26a7f4d808dee450b"
		)
	]
)