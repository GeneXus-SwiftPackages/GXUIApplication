...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.2.0-beta.8.xcframework.zip",
			checksum: "9549fa0b9a0c192466fb9b9a6339cc3821692c93ca4f456862fa99280850c753"
		)
	]
)