...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.4.0-beta.20.xcframework.zip",
			checksum: "8607c3b86cb5d368107f08e5fb6605be411e90dff035becab1dc51ebf775cd8e"
		)
	]
)