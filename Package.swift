...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.1.0-beta.24.xcframework.zip",
			checksum: "e3938289aba811db2acda2df48a0977e7dbab3146d921957666e32af728bbaff"
		)
	]
)