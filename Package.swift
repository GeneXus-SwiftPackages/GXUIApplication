...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-5.0.0-rc.0.xcframework.zip",
			checksum: "43f6700d5383f4dfd96d1015301909178d569678fecceda7b5d17f1a00806837"
		)
	]
)