...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.11.xcframework.zip",
			checksum: "b2607f3f5139485d95cec200f7600491d705a69f663fa694e497eefce188563d"
		)
	]
)