...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.19.xcframework.zip",
			checksum: "4ac382680f56d2eb3b31a1da69f3082938eb4dc83fca314c6572f9ce9ccad44d"
		)
	]
)