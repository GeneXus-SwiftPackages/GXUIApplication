...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.10.xcframework.zip",
			checksum: "5430591fd25daa3fb2dcc9af54f7669dba84c9cb67febcfda620e353b87c849c"
		)
	]
)