...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.20.xcframework.zip",
			checksum: "4ded2056b7d9e74f348b74e30d14d82a6f28b75cc9443f79d4679f38996855b2"
		)
	]
)