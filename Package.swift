...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.4.0-beta.3.xcframework.zip",
			checksum: "8058380269c8b46acd17ecdd74453c762aafd5be4193bf4870055dccdffc97cd"
		)
	]
)