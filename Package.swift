...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.11.xcframework.zip",
			checksum: "f8bb26eafb797ddfdde19109aab141125f562fd147eab1888d9e8fd74c2d4f56"
		)
	]
)