...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.5.xcframework.zip",
			checksum: "1307c56d1187573075462d4a50045f2aeff7f8265ee4bd17869ee3a8bf972efe"
		)
	]
)