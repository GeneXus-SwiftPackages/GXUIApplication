...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.2.2.xcframework.zip",
			checksum: "f1596247766be7b355c7c7d7594963deab26ea0debbf1478774e394182a5655f"
		)
	]
)