...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.12.xcframework.zip",
			checksum: "bdc102097f471824d2fbf7a8d0d710286ec9e4f6ac432e276d4e766a615db138"
		)
	]
)