...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.32.xcframework.zip",
			checksum: "f2908a8d87052c62e097ba72f04c883a1240abc439ffbec02b278af4aaed79df"
		)
	]
)