...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.18.xcframework.zip",
			checksum: "6ba0c5abe25e0c0161b457bb2b71c8159296d762a6d304b1f6e31ba0991b438d"
		)
	]
)