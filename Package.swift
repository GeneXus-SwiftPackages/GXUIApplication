...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.5.xcframework.zip",
			checksum: "478372643b87a8101ae6469c441fc3b27d3a15b43a0adfd441851e31304d5975"
		)
	]
)