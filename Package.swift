...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.26.xcframework.zip",
			checksum: "8fb2923391b09ffa370328168964f583aa0084f87a3ffbae66bc6622b57f7903"
		)
	]
)