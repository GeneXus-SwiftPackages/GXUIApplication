...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.10.xcframework.zip",
			checksum: "9eebfac52c25160dde2cda40e346b8bc6d430b76015b338663abef6df3bfa46b"
		)
	]
)