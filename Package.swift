...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.4.xcframework.zip",
			checksum: "d4ae18317c5965d632731ce1389fa932085cad9903168d1891389876ee333865"
		)
	]
)