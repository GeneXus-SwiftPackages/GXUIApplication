...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.4.27.xcframework.zip",
			checksum: "955097f896f2545bab6921bb396faa1be933b9d265f3f293cd51a2390a31f467"
		)
	]
)