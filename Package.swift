...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.17.xcframework.zip",
			checksum: "20ba6de4c4b2c93446d634a63a36248410c206b2afcf67c61f35ae21d988e9d8"
		)
	]
)