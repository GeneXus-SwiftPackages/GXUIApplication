...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.1.0-beta.10.xcframework.zip",
			checksum: "19e0ae0c4ea57fb60bfa795de1726926b2d270729633b825e8f2252f8777b3a9"
		)
	]
)