...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.2.1.xcframework.zip",
			checksum: "a49aab46b792e7cff229c222d90d5152188be3fb825ce3ca6fdc3b93a0c7663e"
		)
	]
)