...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-3.1.1.xcframework.zip",
			checksum: "eef81323af2b82c7cdcabd4be93e578704dddacf22fb7b6ab0896402f9af3e2a"
		)
	]
)