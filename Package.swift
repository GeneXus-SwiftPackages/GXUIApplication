...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.5.xcframework.zip",
			checksum: "95d6666bac2b93fda9da0933435fdf3087fd4b38b029a7e2cb2834d97e277f67"
		)
	]
)