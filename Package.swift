...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.35.xcframework.zip",
			checksum: "438a9d77a6fd30f3a0805e3015d345d299f5779db4d8abb1006b144eec0315d8"
		)
	]
)