...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-2.1.0-rc.23.xcframework.zip",
			checksum: "04728714678460b7e380351b97ff23ca6f1bd76dca39b283d138f9140561465d"
		)
	]
)