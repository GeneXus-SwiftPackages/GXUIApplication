...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.5.12.xcframework.zip",
			checksum: "5fb688ecde1dc929a681b798b77b12af37b197a67f1d7e812e777179bc1fd45f"
		)
	]
)