...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.33.xcframework.zip",
			checksum: "41af140e95203c1bcf9eae1077e72b4fdb613811d4805525e06d04ef1264531f"
		)
	]
)