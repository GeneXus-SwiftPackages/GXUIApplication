...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.14.xcframework.zip",
			checksum: "5d3b3153f9e92cd4b056045ae05d9be51fba81413b1cc2e9ecd437291763845a"
		)
	]
)