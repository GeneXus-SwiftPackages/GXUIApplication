...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.2.0-rc.25.xcframework.zip",
			checksum: "4c2505b14ffeccd15ae5ebbcfe64a4cedc6f9e92ddf389cc388a1d1a7af16504"
		)
	]
)