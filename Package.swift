...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.7.xcframework.zip",
			checksum: "8ad15497ee368fa9ba687bd318b5ce1f41797b9d25e32ca0d00b3b58ab940747"
		)
	]
)