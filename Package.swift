...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-3.2.0-rc.0.xcframework.zip",
			checksum: "cc395e1c4f368a9c6178d415b5c0a04b306231ed6dd684017cdea01ddcd76b33"
		)
	]
)