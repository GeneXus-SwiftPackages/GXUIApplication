...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.1.0-beta.5.xcframework.zip",
			checksum: "79018daf18e371f0c1166c40ed59e3060c0b736d3db1f5476e67acbb470586ae"
		)
	]
)