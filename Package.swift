...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.17.xcframework.zip",
			checksum: "6afdadab179dbec22736eaa45eeb41dda51e4aeb24810444f8c04b54a8681d4d"
		)
	]
)