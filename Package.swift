...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.26.xcframework.zip",
			checksum: "353d9559d7c730c8b6a088a886f8f16f70bf97f0b8fd1961b30ed4567a189fe8"
		)
	]
)