...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.0.0-beta.20230706155940.xcframework.zip",
			checksum: "bde58e17e8560fd0602445c75bf0c671a682e3b0cc7ca1d13fe2a718fcc128e4"
		)
	]
)