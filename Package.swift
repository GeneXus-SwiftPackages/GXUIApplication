...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.19.xcframework.zip",
			checksum: "d2259ced6ae9b648ad5232050409acdb5fbe48a1592561a3adb7d8c385176110"
		)
	]
)