...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.7.xcframework.zip",
			checksum: "070288ce142e425573184c40b275b768c9ceed7c2d47718da713699dbd24e603"
		)
	]
)