...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.0.0-beta.10.xcframework.zip",
			checksum: "d8a095e07b4967790d50fc8ee86f34adb780fec69634e8bda6ee9b6484a9a5aa"
		)
	]
)