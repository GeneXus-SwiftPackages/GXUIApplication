...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-4.0.0-rc.43.xcframework.zip",
			checksum: "a00c4f304f1d46cd4b94e9788ef32a69739c2941f24955cc7c21d427217281de"
		)
	]
)