...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.6.0-beta.0.xcframework.zip",
			checksum: "ff71ee75f58773e6ea8d5a1d9d3d3847eaa0ea9411a69c7da620fc8d23f8ecbd"
		)
	]
)