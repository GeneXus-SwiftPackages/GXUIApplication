...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.25.xcframework.zip",
			checksum: "1e7d72328774c20bb04b25443030aab319a0d0121442cd31a94c64ae1efcfc14"
		)
	]
)