...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.9.xcframework.zip",
			checksum: "417e5eed72e61610f6bcf20440fc752321361b017deeab67d303728eae9713a8"
		)
	]
)