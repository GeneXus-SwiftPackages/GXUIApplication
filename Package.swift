...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.25.xcframework.zip",
			checksum: "b3a75939411bf71dffd1d75730fd518a6a1d20c9db399852292d138019e7eaa1"
		)
	]
)