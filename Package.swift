...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-3.2.0-rc.9.xcframework.zip",
			checksum: "cd3290ed204626e96874563e7d4240a2da7e2278e9c23ead1f3f72bf9893ad64"
		)
	]
)