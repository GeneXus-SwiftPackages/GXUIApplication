...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.28.xcframework.zip",
			checksum: "c6b4fd825d680b3a192325e7965ce47db18aca8dbefb4c8d22f387af6546fdf4"
		)
	]
)