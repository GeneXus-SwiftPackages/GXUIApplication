...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.9.xcframework.zip",
			checksum: "1c2f18f81f820b1a5796c7873aac52aadd4364a17d4f94541282105340739b5a"
		)
	]
)