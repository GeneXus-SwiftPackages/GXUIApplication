...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.5.11.xcframework.zip",
			checksum: "7ad47ace254baa1e02f7c5895e33b3d7f96ea2b97d4e5059a03c343a77db6271"
		)
	]
)