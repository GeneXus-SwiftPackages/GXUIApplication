...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.20.xcframework.zip",
			checksum: "94a95359fd2d1d4aaa732e6bdaa6ecb8c995a494cb34d9e5c1573abf6189fb3f"
		)
	]
)