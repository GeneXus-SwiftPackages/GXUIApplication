...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-3.1.0-rc.3.xcframework.zip",
			checksum: "5600fcfed010ab66e922190d9f141b8bb10c35aafca11398c2470fbd0a68e9d5"
		)
	]
)