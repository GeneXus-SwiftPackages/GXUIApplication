...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.0.0-beta.20230710220444.xcframework.zip",
			checksum: "6ae70b61ce9fbfcc917cb4217a73b6632a06ac488cd6016a1a40b790515e2139"
		)
	]
)