...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.1.0-rc.3.xcframework.zip",
			checksum: "5583eec946f4874bad49aafe631f58b51aec13c372bcb0bdcbd9b391a3d6e035"
		)
	]
)