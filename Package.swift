...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.6.0-beta.3.xcframework.zip",
			checksum: "bfda879689066f016ff5d08977ab4495a3a6159cd8b7f220beebd7e3c5a3cacd"
		)
	]
)