...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.7.xcframework.zip",
			checksum: "d33508454f74c28716a599c947f7ed4d853eddb6615d5ec930bb44e0d5030e7b"
		)
	]
)