...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.4.0-beta.8.xcframework.zip",
			checksum: "16e5d6c977b10a1a682e687f09ef429f9a4d016b9cd7fa09a51a29572a035b83"
		)
	]
)