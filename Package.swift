...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-3.1.4.xcframework.zip",
			checksum: "0723851994bb6d9160c84e4b8bdf295ac2f2eaf9f26e96d9e75073ff2bd2fb24"
		)
	]
)