...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.11.xcframework.zip",
			checksum: "2df3e365200c4555a41b8fa72c0a194e1f628fd26439bc6c5e87c027b519b3f1"
		)
	]
)