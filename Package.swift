...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.0.9.xcframework.zip",
			checksum: "90a464a4aaa841319ca4728ff216006f40e09cfb15d34132be377920dafcca71"
		)
	]
)