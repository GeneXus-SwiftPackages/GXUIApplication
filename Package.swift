...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.32.xcframework.zip",
			checksum: "7e83197dfe8a29d6c9913913a2df5d82e013249e487f3e224d1e0179447f983a"
		)
	]
)