...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.21.xcframework.zip",
			checksum: "74df6505fbf8145001b9a2299cbd6c238f100c1fba2728a01ee63d511bdb7fbd"
		)
	]
)