...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.36.xcframework.zip",
			checksum: "b3262a04c478639a1ff6471bc16efabee541ce5a60a43dc1cee2ad50d93b92c4"
		)
	]
)