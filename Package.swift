...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.17.xcframework.zip",
			checksum: "6d8b22fe0337a6256c776cf7d4e97bd8c29e6bee4c2d737098d05f03b6b8689e"
		)
	]
)