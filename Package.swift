...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.21.xcframework.zip",
			checksum: "2fe62cf2943487002e43a5c7fb65b3d6232415b7c16d32a97c774d45fefda9d1"
		)
	]
)