...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.25.xcframework.zip",
			checksum: "9d363ec7bbb0055defb24034ea3629065eec215c7c2c05a8362e205eba3495c8"
		)
	]
)