...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-4.1.0-rc.22.xcframework.zip",
			checksum: "bb3f89c7061a99a5d224155d8594eb65debdba22c973e63242c0e81c4b244f04"
		)
	]
)