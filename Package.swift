...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.20.xcframework.zip",
			checksum: "36b8d5661bca32e03045f54098d487497f2347caa1ef277524da1a3ff578a2e1"
		)
	]
)