...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.2.0-beta.12.xcframework.zip",
			checksum: "0c2617e80b763c254d5f4d564ac8afa78da7c2da759a4e702d12e71803df78b9"
		)
	]
)