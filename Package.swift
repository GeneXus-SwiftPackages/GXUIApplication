...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.1.0-beta.7.xcframework.zip",
			checksum: "fa6bb9d4f26f68b07d31cc3f2d5309cc55b76d48abea9a892711942673b66b81"
		)
	]
)