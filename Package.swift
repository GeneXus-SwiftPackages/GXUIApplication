...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.1.0-beta.9.xcframework.zip",
			checksum: "d4d7d30f3f969228fff4b163a4c54b495fa83347a2cc2d6fc2f89aeb96cea8e2"
		)
	]
)