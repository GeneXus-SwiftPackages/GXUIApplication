...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.2.0-beta.9.xcframework.zip",
			checksum: "ea90fd26e2e0d5fd63359652f398b9bbfe02bc955eae2be54142d83293f1044f"
		)
	]
)