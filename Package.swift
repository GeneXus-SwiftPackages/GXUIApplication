...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.3.0-rc.1.xcframework.zip",
			checksum: "7097c20875b53014f09e0d54f95bd1de52033406327bb60b3108fd57d0696c9c"
		)
	]
)