...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.0.16.xcframework.zip",
			checksum: "df32b372d3e32994fc5a308cd406ea06b2f4d00adff413c9a43c52eff0f2cf1d"
		)
	]
)