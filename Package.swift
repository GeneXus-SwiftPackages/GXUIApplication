...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.14.xcframework.zip",
			checksum: "590173f327af9a00d12a44475bb26a99e64165ddd55b8b30ccf595628ada88b5"
		)
	]
)