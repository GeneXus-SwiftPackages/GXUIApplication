...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.2.xcframework.zip",
			checksum: "1a1a6719914d400b7e0e6fef67b8cc34ebadd8979d0b9501cca9c634c3db5ea4"
		)
	]
)