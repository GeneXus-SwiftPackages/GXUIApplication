...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.3.0-beta.2.xcframework.zip",
			checksum: "e1573c5b2c7e464443febfd5f712bcb2a3df3516ead94cd030078a263e46dd9a"
		)
	]
)