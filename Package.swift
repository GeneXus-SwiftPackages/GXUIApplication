...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-4.1.0-rc.24.xcframework.zip",
			checksum: "7d6c87e17dbbca065a571ebe2caa86dfb659c7f3a3adc535ca4a76315149f83c"
		)
	]
)