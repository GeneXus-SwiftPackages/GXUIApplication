...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.4.0-beta.13.xcframework.zip",
			checksum: "360b2e0fe6764dfb6c5e2990f644d7a1d139ecae66a18b7ea360d1ad07969b0c"
		)
	]
)