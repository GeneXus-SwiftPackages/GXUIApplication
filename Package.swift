...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.31.xcframework.zip",
			checksum: "0626408d46340a83c41d41c3e4ed7a543115465a931bc66d3c2a06eb327ea3a6"
		)
	]
)