...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.25.xcframework.zip",
			checksum: "6a35f83233e80fea3c9ca0bfc1da11e076cf3eac8f53dc5ac1d955e21a831c72"
		)
	]
)