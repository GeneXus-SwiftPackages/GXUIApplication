...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.11.xcframework.zip",
			checksum: "5d31610c8ef6cc0223f3306f6da8dc00160461a0c59533bf5b03cd0fc67926ee"
		)
	]
)