...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.0.6.xcframework.zip",
			checksum: "61fbd9571e5a3f1b6ad83ffd265328173303d61a9bc78d977895ab5733eab4da"
		)
	]
)