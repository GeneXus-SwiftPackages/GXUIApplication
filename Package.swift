...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.20.xcframework.zip",
			checksum: "cde6da7b40ce226c412117898b4c7e92d84ecac1f29acfbef76a8dd23cb2a4de"
		)
	]
)