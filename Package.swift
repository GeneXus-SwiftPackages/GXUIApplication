...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.38.xcframework.zip",
			checksum: "468422afe8683e14e5c5f53faa32c88f78e5a45c3eb436c9823ca962bbf0d289"
		)
	]
)