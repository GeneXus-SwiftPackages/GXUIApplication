...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-5.0.0-beta.4.xcframework.zip",
			checksum: "157ad971cebfd27835b03b2c80e5d6b630577df476a388d6751ef11c8aed8370"
		)
	]
)