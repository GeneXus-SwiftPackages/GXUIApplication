...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.41.xcframework.zip",
			checksum: "168f41cb080dcaab32fd2c354fb63ef132bb8233eaaf651980b10e7183fc3b9e"
		)
	]
)