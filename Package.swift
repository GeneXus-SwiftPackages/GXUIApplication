...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.2.0-beta.12.xcframework.zip",
			checksum: "acc3aa17f3d20fa887cbffbe0e2c918e27b5a9b9a06656f5583a428fec0e4742"
		)
	]
)