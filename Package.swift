...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.22.xcframework.zip",
			checksum: "2232869e34fc38ef6421ac273662498207cf92ca73d2f1887ca4dfe1f834fceb"
		)
	]
)