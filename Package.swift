...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.5.0-beta.26.xcframework.zip",
			checksum: "ba1482884ff1c9f40393b533d9d40d1b84cc5c3e341f89ae5ca60c0bf2cb8328"
		)
	]
)