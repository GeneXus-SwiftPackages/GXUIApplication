...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-1.2.0-rc.29.xcframework.zip",
			checksum: "8c52ba6396684bed866fee7df628f01b2c485b265935ca8009722138942babdc"
		)
	]
)