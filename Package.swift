...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.0.0-beta.36.xcframework.zip",
			checksum: "7008f01841d87262e598c89305f2655f51b91411516c76e9e27e1805689d1a6a"
		)
	]
)