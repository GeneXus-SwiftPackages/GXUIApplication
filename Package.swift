...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.0.0-beta.16.xcframework.zip",
			checksum: "bb228e6dca6cebc0755a6c8904b2f32955dc65ae757878496a74ae362a349048"
		)
	]
)