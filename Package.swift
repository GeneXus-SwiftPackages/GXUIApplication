...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-2.2.0-beta.13.xcframework.zip",
			checksum: "fec1d50435094e6f421c82e695bccff77c0683f9bbb5c00624267498c573d9a1"
		)
	]
)