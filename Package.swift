...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.4.0-beta.17.xcframework.zip",
			checksum: "a9af1cfc9596ef8698fdba42a0a7a88c85033be146479171a64db9b1c4ed6ebb"
		)
	]
)