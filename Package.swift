...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.31.xcframework.zip",
			checksum: "d5e2eacfbde4a17b03ca96a77110faf3816e32a4d604c2c257c2a145f7d6ac93"
		)
	]
)