...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-4.1.0-rc.8.xcframework.zip",
			checksum: "ef0a412db80add2ee91259b45f97e144f5fb6d3c9a901754792175f06a5b79a1"
		)
	]
)