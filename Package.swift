...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.1.0-beta.9.xcframework.zip",
			checksum: "d0ff357e9879754cbd25c38dba247272f76f6972880ec93975de0d098626c352"
		)
	]
)