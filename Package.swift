...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.0.0-beta.44.xcframework.zip",
			checksum: "34b1343b8e78b6c49b1075fd3c256150a9ff54f7650f546de15c58d41d4c97c4"
		)
	]
)