...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-5.0.0-beta.1.xcframework.zip",
			checksum: "bfb4d7287e208ebf2a076c3bdb1ce9dbfed1f95b5b0e789846391707957c2658"
		)
	]
)