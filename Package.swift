...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-1.2.0-beta.33.xcframework.zip",
			checksum: "820c66a5c6d95566a5a25b54062b08c6106d8e7521842b1afb045115426938f2"
		)
	]
)