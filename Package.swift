...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-1.4.30.xcframework.zip",
			checksum: "ea09748638006845651c1e8690c9e35052bd639fe3985bb0e1dda3f0a31ac364"
		)
	]
)