...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUIApplication-4.2.0-rc.0.xcframework.zip",
			checksum: "62f5664c24cb12a0ccb273b9e1fe84a542c19adac6fe04e3df5906da85582078"
		)
	]
)