...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-3.1.0-beta.5.xcframework.zip",
			checksum: "cad61a1a38e718c793024b9f099dd81c9af591daee3f4af66a34c76b490c0f40"
		)
	]
)