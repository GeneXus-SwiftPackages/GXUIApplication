...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUIApplication-4.1.3.xcframework.zip",
			checksum: "58bfc8fccccba13ad404020c332bea73a8a192cfa326950e1d819e52cc219441"
		)
	]
)