...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUIApplication",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUIApplication-4.2.0-beta.35.xcframework.zip",
			checksum: "b9e1e66b35087fe71d14f65b2ac52cfe582655f3cc078e9318f3592b0d3c8011"
		)
	]
)